import { world, system, EasingType, EntityComponentTypes, ItemStack, Entity, Dimension, BlockVolume, Vector3, EquipmentSlot } from "@minecraft/server";
...
function fission(entity: Entity, dimension: Dimension) {
...
function fusion(entity: Entity, dimension: Dimension) {
  const randomMath = makeRandomId();
    const random = `${randomMath}`;
