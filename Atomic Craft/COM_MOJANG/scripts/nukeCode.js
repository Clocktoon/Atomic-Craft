    ...
    onPlayerInteract(event) {
        ...
        system.runTimeout(() => {
            function* blockGen() {
                ...
                for (const eny of block.dimension.getEntities({ location: block.location, maxDistance: 50 })) {
                ...
                yield
                const from2 = {
                    x: block.location.x - 70,
                    y: block.location.y - 20,
                    z: block.location.z - 70
                }
                ...
                block.dimension.runCommand(`tickingarea add 
                ${px - 195} 0 ${pz - 195} ${px - 330} 0 ${pz - 330} nukearea5`)
