            ...
            if (params.atom == true) {
                ...
                world.tickingAreaManager
                    ...
                    function* blockGen() {
                        ...
                        //Nuke Code!!!
                        nuclearArea(block.dimension.id, block.location, block, 272, 70);
                ...
                world.tickingAreaManager
                    ...
                    system.runTimeout(() => {
                        function* blockGen() {
                            ...
                            //Shockwave and explosion sound
                            playExplosionAudio(block.dimension, block.location, 120);
                            // shockwaveBlast(
                            //   dimension,
                            //   block.location,
                            //   3,
                            ...
                            //Gets rid of ticking area and starts the real nuclear explosion code
                            //Nuke Code!!!
                            nuclearArea(block.dimension.id, block.location, block, 128, 40);
                            const volume = new BlockVolume({
                                x: block.location.x - 20,
                                y: block.location.y - 20,
                                z: block.location.z - 20,
                ...
                world.tickingAreaManager
                    ...
                    system.runTimeout(() => {
                        function* blockGen() {
                            ...
                            //Shockwave and explosion sound
                            playExplosionAudio(block.dimension, block.location, 400);
                            // shockwaveBlast(
                            //   dimension,
                            //   block.location,
                            //   3,
                            ...
                            // );
                            //Nuke Code!!!
                            nuclearArea(block.dimension.id, block.location, block, 352, 208);
                            const volume = new BlockVolume({
                                x: block.location.x - 20,
                                y: block.location.y - 20,
                                z: block.location.z - 20,
