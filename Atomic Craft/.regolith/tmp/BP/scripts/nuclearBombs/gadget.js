...
export function directionTo(target, from) {
...
export function gadgetCode(block, playerEntity, dimension, doMenu) {
        ...
        world.tickingAreaManager
            ...
            system.runTimeout(() => {
                function* blockGen() {
                    ...
                    //Nuke Code!!!
                    nuclearArea(block.dimension.id, block.location, block, 112, 40, 50, playerEntity);
