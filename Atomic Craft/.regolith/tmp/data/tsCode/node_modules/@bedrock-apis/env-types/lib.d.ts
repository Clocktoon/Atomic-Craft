...
interface BigInt {
    ...
    /** Returns a string representation appropriate to the host environment's current
...
interface BigInt64Array<TArrayBuffer extends ArrayBufferLike = ArrayBufferLike> {
    ...
    /** Converts the array to a string by using the current
...
interface Date {
     ...
     */
    /**
     * Converts a date to a string by using the current or specified
     * @param
     * @param options An object that contains one or more properties that specify comparison options.
     */
    /**
     * Converts a time to a string by using the current or specified
     * @param
     * @param options An object that contains one or more properties that specify comparison options.
     */
}
...
interface Number {
    /**
     * Converts a number to a string by using the current or specified
     * @param
     * @param options An object that contains one or more properties that specify comparison options.
     */
}
...
interface String {
    ...
    /** Converts all alphabetic characters to lowercase, taking into account the host environment's current
    /** Returns a string where all alphabetic characters have been converted to uppercase, taking into account the host environment's current
    /**
